...
const STEP_TIMINGS_MS = [0, 800, 1650, 2500, 3300]; // step N active at ms; last = complete
    ...
    <div className="animate-in fade-in duration-500">
      <PageHeader title="Deal Brief" subtitle="NovaCura Therapeutics">
        <div className="flex items-center gap-2">
          <button
            ...
            className={cn(
              ...
              isRunning
                ...
                : isComplete
                  ? 'border-[hsl(160,84%,39%,0.4)] bg-[hsl(160,84%,39%,0.08)] text-[hsl(160,84%,39%)] hover:bg-[hsl(160,84%,39%,0.14)]'
          ...
          <button className="inline-flex items-center gap-2 px-3 py-2 rounded-md bg-primary text-primary-foreground hover:bg-primary/90 text-sm font-medium transition-colors">
      ...
      <div className="bg-card border border-card-border rounded-xl p-8 max-w-4xl">
        ...
        {/* Timestamp + controlled snapshot strip */}
          ...
          <AnimatePresence>
            {isComplete && (
              <motion.div
                ...
                className="flex items-start gap-3 px-3 py-2.5 rounded-lg border border-primary/20 bg-primary/5 w-fit"
              >
                <Lock className="w-3.5 h-3.5 text-primary flex-shrink-0 mt-0.5" />
                <div>
                  <p className="text-xs font-semibold text-primary">Controlled snapshot</p>
